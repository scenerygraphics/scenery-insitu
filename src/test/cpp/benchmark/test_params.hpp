...
#define INIT sysv ## _init // create resource in beginning before other side joins
#define SEND sysv ## _send // send data
#define RECV sysv ## _recv // receive data
#define TERM sysv ## _term // delete resource
