...
//                var tcpSubscriber: ZMQ.Socket = context.createSocket(ZMQ.SUB)
//                val address = "tcp://192.168.0.200:6655"
//                try {
//                    tcpSubscriber.connect(address)
//                    tcpSubscriber.subscribe(ZMQ.SUBSCRIPTION_ALL)
//                } catch (e: ZMQException) {
//                    logger.warn("Binding failed")
//                    e.printStackTrace()
//                }
//
...
//
//                while(true) {
//                    val payload = tcpSubscriber.recv()
//                    if (payload != null) {
//
